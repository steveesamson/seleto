...
//empty seleto for utility
    ...
    seleto.fn.el = function (index) {
        ...
        return ((this.length === 0) || (index > this.length))? null:this.nodes[index - 1];
    };
    ...
    seleto.fn.css = function (name, value) {
        ...
        if (name && isString(name) && isUndefined(value)) {
            var _this = this.nodes[0];
        ...
        this.each(function () {
            ...
            if (name && value && isString(name) && isString(value)) {
